...
namespace Composio
{
    ...
    public sealed partial class PostV31ToolsExecuteByToolSlugRequestCustomConnectionDataVariant11Val
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostV31ToolsExecuteByToolSlugRequestCustomConnectionDataVariant11Val" /> class.
        /// </summary>
...
#endif
        public PostV31ToolsExecuteByToolSlugRequestCustomConnectionDataVariant11Val(
            string accessToken,
            string clientId,
            string clientSecret,
            string? subdomain,
