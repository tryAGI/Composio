...
namespace Composio
{
    public partial class WebhookEndpointsClient
    {
        ...
        private static readonly global::Composio.EndPointSecurityRequirement s_GetWebhookEndpointsSecurityRequirement0 =
        ...
        private static readonly global::Composio.EndPointSecurityRequirement[] s_GetWebhookEndpointsSecurityRequirements =
            new global::Composio.EndPointSecurityRequirement[]
            {                s_GetWebhookEndpointsSecurityRequirement0,
            };
        partial void PrepareGetWebhookEndpointsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? toolkitSlug);
        partial void PrepareGetWebhookEndpointsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? toolkitSlug);
        partial void ProcessGetWebhookEndpointsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetWebhookEndpointsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Composio.GetWebhookEndpointsResponse> GetWebhookEndpointsAsync(
            string? toolkitSlug = default,
            global::Composio.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetWebhookEndpointsAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Composio.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Composio.AutoSDKHttpResponse<global::Composio.GetWebhookEndpointsResponse>> GetWebhookEndpointsAsResponseAsync(
            string? toolkitSlug = default,
            global::Composio.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetWebhookEndpointsArguments(
            ...
            var __authorizations = global::Composio.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetWebhookEndpointsSecurityRequirements,
                operationName: "GetWebhookEndpointsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetWebhookEndpointsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Composio.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Composio.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetWebhookEndpointsAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetWebhookEndpointsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Composio.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetWebhookEndpointsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Composio.GetWebhookEndpointsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Composio.AutoSDKHttpResponse<global::Composio.GetWebhookEndpointsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Composio.GetWebhookEndpointsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
