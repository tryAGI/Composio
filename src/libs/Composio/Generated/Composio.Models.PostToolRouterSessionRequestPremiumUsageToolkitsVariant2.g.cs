...
namespace Composio
{
    ...
    public sealed partial class PostToolRouterSessionRequestPremiumUsageToolkitsVariant2
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostToolRouterSessionRequestPremiumUsageToolkitsVariant2" /> class.
        /// </summary>
        /// <param name="disable">
        /// These specific toolkits will be disabled<br/>
        /// Example: [gmail, slack]
...
#endif
        public PostToolRouterSessionRequestPremiumUsageToolkitsVariant2(
