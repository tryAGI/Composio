...
namespace Composio
{
    ...
    public sealed partial class PatchToolRouterSessionBySessionIdResponseExperimentalCustomTool
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PatchToolRouterSessionBySessionIdResponseExperimentalCustomTool" /> class.
        /// </summary>
        /// <param name="slug">
        /// Prefixed tool slug (e.g. LOCAL_GMAIL_GET_IMPORTANT_EMAILS)
        /// </param>
...
#endif
        public PatchToolRouterSessionBySessionIdResponseExperimentalCustomTool(
            string slug,
            string name,
            string description,
