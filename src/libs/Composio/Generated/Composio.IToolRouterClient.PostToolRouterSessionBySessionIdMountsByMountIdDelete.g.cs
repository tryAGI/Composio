...
namespace Composio
{
    public partial interface IToolRouterClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Composio.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Composio.AutoSDKHttpResponse<global::Composio.PostToolRouterSessionBySessionIdMountsByMountIdDeleteResponse>> PostToolRouterSessionBySessionIdMountsByMountIdDeleteAsResponseAsync(
            string sessionId,
            string mountId,
