...
namespace Composio
{
    public partial interface IToolRouterClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Composio.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Composio.AutoSDKHttpResponse<global::Composio.GetToolRouterSessionBySessionIdMountsByMountIdItemsResponse>> GetToolRouterSessionBySessionIdMountsByMountIdItemsAsResponseAsync(
            string sessionId,
            string mountId,
            string? cursor = default,
            double? limit = default,
