...
namespace Composio
{
    ...
    {
        partial void PreparePostV31ToolsScopesRequiredArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Composio.PostV31ToolsScopesRequiredRequest request);
        partial void PreparePostV31ToolsScopesRequiredRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Composio.PostV31ToolsScopesRequiredRequest request);
        partial void ProcessPostV31ToolsScopesRequiredResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPostV31ToolsScopesRequiredResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Composio.PostV31ToolsScopesRequiredResponse> PostV31ToolsScopesRequiredAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePostV31ToolsScopesRequiredArguments(
            ...
            PreparePostV31ToolsScopesRequiredRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessPostV31ToolsScopesRequiredResponse(
                httpClient: HttpClient,
                httpResponseMessage: __response);
            // Bad request - Invalid body parameters or tools from different toolkits
            ...
            // Not found - One or more tools could not be resolved for the requested version
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessPostV31ToolsScopesRequiredResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                try
                {
                    ...
                    return
                        global::Composio.PostV31ToolsScopesRequiredResponse.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::Composio.PostV31ToolsScopesRequiredResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Composio.PostV31ToolsScopesRequiredResponse> PostV31ToolsScopesRequiredAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Composio.PostV31ToolsScopesRequiredRequest
            {
                Tools = tools,
                Version = version,
            };

            return await PostV31ToolsScopesRequiredAsync(
                request: __request,
                cancellationToken: cancellationToken).ConfigureAwait(false);
        }
    }
