...
namespace Composio
{
    ...
    {
        partial void PreparePostV31ToolsExecuteByToolSlugArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string toolSlug,
            ref string? xLlmGatewayHeaders,
            global::Composio.PostV31ToolsExecuteByToolSlugRequest request);
        partial void PreparePostV31ToolsExecuteByToolSlugRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string toolSlug,
            string? xLlmGatewayHeaders,
            global::Composio.PostV31ToolsExecuteByToolSlugRequest request);
        partial void ProcessPostV31ToolsExecuteByToolSlugResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPostV31ToolsExecuteByToolSlugResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Composio.PostV31ToolsExecuteByToolSlugResponse> PostV31ToolsExecuteByToolSlugAsync(
            string toolSlug,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePostV31ToolsExecuteByToolSlugArguments(
            ...
            var __pathBuilder = new global::Composio.PathBuilder(
                path: $"/api/v3.1/tools/execute/{toolSlug}",
            ...
            PreparePostV31ToolsExecuteByToolSlugRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessPostV31ToolsExecuteByToolSlugResponse(
                httpClient: HttpClient,
            ...
            if ((int)__response.StatusCode == 403)
            {
                ...
                try
                {
                    if (ReadResponseAsString)
                    {
                        ...
                        __value_403 = global::Composio.Error.FromJson(__content_403, JsonSerializerOptions);
                    }
                    else
                    {
                        __content_403 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
            ...
            if ((int)__response.StatusCode == 408)
            {
                ...
                try
                {
                    if (ReadResponseAsString)
                    {
                        ...
                        __value_408 = global::Composio.Error.FromJson(__content_408, JsonSerializerOptions);
                    }
                    else
                    {
                        __content_408 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
            ...
            if ((int)__response.StatusCode == 413)
            {
                ...
                global::Composio.Error? __value_413 = null;
                try
                {
                    if (ReadResponseAsString)
                    {
                        __content_413 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                        __value_413 = global::Composio.Error.FromJson(__content_413, JsonSerializerOptions);
                    }
                    else
                    {
                        __content_413 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
            ...
            if ((int)__response.StatusCode == 422)
            {
                ...
                try
                {
                    if (ReadResponseAsString)
                    {
                        ...
                        __value_422 = global::Composio.Error.FromJson(__content_422, JsonSerializerOptions);
                    }
                    else
                    {
                        __content_422 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
            ...
            if ((int)__response.StatusCode == 429)
            {
                ...
                try
                {
                    if (ReadResponseAsString)
                    {
                        ...
                        __value_429 = global::Composio.Error.FromJson(__content_429, JsonSerializerOptions);
                    }
                    else
                    {
                        __content_429 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
            ...
            if ((int)__response.StatusCode == 501)
            {
                ...
                try
                {
                    if (ReadResponseAsString)
                    {
                        ...
                        __value_501 = global::Composio.Error.FromJson(__content_501, JsonSerializerOptions);
                    }
                    else
                    {
                        __content_501 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
            ...
            if ((int)__response.StatusCode == 502)
            {
                ...
                global::Composio.Error? __value_502 = null;
                try
                {
                    if (ReadResponseAsString)
                    {
                        __content_502 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                        __value_502 = global::Composio.Error.FromJson(__content_502, JsonSerializerOptions);
                    }
                    else
                    {
                        __content_502 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
            ...
            if ((int)__response.StatusCode == 503)
            {
                ...
                global::Composio.Error? __value_503 = null;
                try
                {
                    if (ReadResponseAsString)
                    {
                        __content_503 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                        __value_503 = global::Composio.Error.FromJson(__content_503, JsonSerializerOptions);
                    }
                    else
                    {
                        __content_503 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessPostV31ToolsExecuteByToolSlugResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                try
                {
                    ...
                    return
                        global::Composio.PostV31ToolsExecuteByToolSlugResponse.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::Composio.PostV31ToolsExecuteByToolSlugResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await PostV31ToolsExecuteByToolSlugAsync(
                toolSlug: toolSlug,
                xLlmGatewayHeaders: xLlmGatewayHeaders,
                request: __request,
                cancellationToken: cancellationToken).ConfigureAwait(false);
