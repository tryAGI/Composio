...
namespace Composio
{
    public partial class OrganizationClient
    {
        ...
        private static readonly global::Composio.EndPointSecurityRequirement s_GetOrgUsageSummarySecurityRequirement0 =
        ...
        private static readonly global::Composio.EndPointSecurityRequirement[] s_GetOrgUsageSummarySecurityRequirements =
            new global::Composio.EndPointSecurityRequirement[]
            {                s_GetOrgUsageSummarySecurityRequirement0,
            };
        partial void PrepareGetOrgUsageSummaryArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? startTime,
            ref string? endTime,
            global::System.Collections.Generic.IList<string>? entityTypes);
        partial void PrepareGetOrgUsageSummaryRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? startTime,
            string? endTime,
            global::System.Collections.Generic.IList<string>? entityTypes);
        partial void ProcessGetOrgUsageSummaryResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetOrgUsageSummaryResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Composio.GetOrgUsageSummaryResponse> GetOrgUsageSummaryAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetOrgUsageSummaryArguments(
            ...
            var __authorizations = global::Composio.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetOrgUsageSummarySecurityRequirements,
                operationName: "GetOrgUsageSummaryAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetOrgUsageSummaryRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Composio.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Composio.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetOrgUsageSummary",
                                methodName: "GetOrgUsageSummaryAsync",
                                pathTemplate: "\"/api/v3/org/usage/summary\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetOrgUsageSummaryResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Composio.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetOrgUsageSummaryResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::Composio.GetOrgUsageSummaryResponse.FromJson(__content, JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::Composio.GetOrgUsageSummaryResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
