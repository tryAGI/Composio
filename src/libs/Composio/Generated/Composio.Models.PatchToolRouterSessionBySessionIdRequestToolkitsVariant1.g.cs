...
namespace Composio
{
    ...
    public sealed partial class PatchToolRouterSessionBySessionIdRequestToolkitsVariant1
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PatchToolRouterSessionBySessionIdRequestToolkitsVariant1" /> class.
        /// </summary>
        /// <param name="enable">
        /// Only these specific toolkits will be enabled<br/>
        /// Example: [gmail, slack, github]
...
#endif
        public PatchToolRouterSessionBySessionIdRequestToolkitsVariant1(
