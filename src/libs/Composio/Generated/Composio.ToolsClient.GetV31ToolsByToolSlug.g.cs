...
namespace Composio
{
    ...
    {
        partial void PrepareGetV31ToolsByToolSlugArguments(
        ...
        partial void PrepareGetV31ToolsByToolSlugRequest(
            global::System.Net.Http.HttpClient httpClient,
        ...
        partial void ProcessGetV31ToolsByToolSlugResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetV31ToolsByToolSlugResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Composio.Tool> GetV31ToolsByToolSlugAsync(
            string toolSlug,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetV31ToolsByToolSlugArguments(
            ...
            PrepareGetV31ToolsByToolSlugRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessGetV31ToolsByToolSlugResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessGetV31ToolsByToolSlugResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                try
                {
                    ...
                    return
                        global::Composio.Tool.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::Composio.Tool.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
