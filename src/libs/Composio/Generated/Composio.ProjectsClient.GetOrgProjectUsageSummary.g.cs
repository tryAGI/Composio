...
namespace Composio
{
    public partial class ProjectsClient
    {
        ...
        private static readonly global::Composio.EndPointSecurityRequirement s_GetOrgProjectUsageSummarySecurityRequirement0 =
        ...
        private static readonly global::Composio.EndPointSecurityRequirement[] s_GetOrgProjectUsageSummarySecurityRequirements =
            new global::Composio.EndPointSecurityRequirement[]
            {                s_GetOrgProjectUsageSummarySecurityRequirement0,
            };
        partial void PrepareGetOrgProjectUsageSummaryArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? startTime,
            ref string? endTime,
            global::System.Collections.Generic.IList<string>? entityTypes);
        partial void PrepareGetOrgProjectUsageSummaryRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? startTime,
            string? endTime,
            global::System.Collections.Generic.IList<string>? entityTypes);
        partial void ProcessGetOrgProjectUsageSummaryResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetOrgProjectUsageSummaryResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Composio.GetOrgProjectUsageSummaryResponse> GetOrgProjectUsageSummaryAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetOrgProjectUsageSummaryArguments(
            ...
            var __authorizations = global::Composio.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetOrgProjectUsageSummarySecurityRequirements,
                operationName: "GetOrgProjectUsageSummaryAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            var __pathBuilder = new global::Composio.PathBuilder(
                                path: "/api/v3/org/project/usage/summary",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetOrgProjectUsageSummaryRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Composio.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Composio.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetOrgProjectUsageSummary",
                                methodName: "GetOrgProjectUsageSummaryAsync",
                                pathTemplate: "\"/api/v3/org/project/usage/summary\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetOrgProjectUsageSummaryResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Composio.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // Invalid time range, entity_types, or query parameters.
                            ...
                            // Failed to load usage from analytics store or feature configuration.
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetOrgProjectUsageSummaryResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::Composio.GetOrgProjectUsageSummaryResponse.FromJson(__content, JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::Composio.GetOrgProjectUsageSummaryResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
