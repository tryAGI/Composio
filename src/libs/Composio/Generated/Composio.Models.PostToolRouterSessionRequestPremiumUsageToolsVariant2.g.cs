...
namespace Composio
{
    ...
    public sealed partial class PostToolRouterSessionRequestPremiumUsageToolsVariant2
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostToolRouterSessionRequestPremiumUsageToolsVariant2" /> class.
        /// </summary>
        /// <param name="disable">
        /// These specific tools will be disabled for this toolkit<br/>
        /// Example: [SLACK_ADD_EMOJI]
...
#endif
        public PostToolRouterSessionRequestPremiumUsageToolsVariant2(
