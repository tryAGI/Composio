...
namespace Composio
{
    ...
    public sealed partial class PatchToolRouterSessionBySessionIdRequestManageConnections
    {
        ...
        /// <summary>
        /// Enable the "remove" action in COMPOSIO_MANAGE_CONNECTIONS to allow deleting connected accounts. Default true.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PatchToolRouterSessionBySessionIdRequestManageConnections" /> class.
        /// </summary>
        /// <param name="enable">
        /// Whether to enable the connection manager for automatic connection handling. If true, we will provide a tool your agent can use to initiate connections to toolkits if it doesnt exist. If set to false, then you have to manage connections manually.<br/>
        /// Example: true
