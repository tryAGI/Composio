...
namespace Composio
{
    ...
    public sealed partial class PatchToolRouterSessionBySessionIdRequestPremiumUsageToolkitsVariant2
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PatchToolRouterSessionBySessionIdRequestPremiumUsageToolkitsVariant2" /> class.
        /// </summary>
        /// <param name="disable">
        /// These specific toolkits will be disabled<br/>
        /// Example: [gmail, slack]
...
#endif
        public PatchToolRouterSessionBySessionIdRequestPremiumUsageToolkitsVariant2(
