...
namespace Composio
{
    ...
    public sealed partial class PatchToolRouterSessionBySessionIdResponseExperimentalCustomToolkitTool
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PatchToolRouterSessionBySessionIdResponseExperimentalCustomToolkitTool" /> class.
        /// </summary>
        /// <param name="slug">
        /// Prefixed tool slug (e.g. LOCAL_CRM_FIND_CUSTOMER)
        /// </param>
...
#endif
        public PatchToolRouterSessionBySessionIdResponseExperimentalCustomToolkitTool(
            string slug,
            string name,
            string description,
