...
namespace Composio
{
    ...
    public sealed partial class PatchToolRouterSessionBySessionIdResponseConfigManageConnections
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PatchToolRouterSessionBySessionIdResponseConfigManageConnections" /> class.
        /// </summary>
        /// <param name="enabled">
        /// Whether to enable the connection manager for automatic connection handling<br/>
        /// Default Value: true
...
#endif
        public PatchToolRouterSessionBySessionIdResponseConfigManageConnections(
            bool? enabled,
            string? callbackUrl,
