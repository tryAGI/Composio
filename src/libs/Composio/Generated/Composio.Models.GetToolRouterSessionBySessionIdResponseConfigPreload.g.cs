...
namespace Composio
{
    ...
    public sealed partial class GetToolRouterSessionBySessionIdResponseConfigPreload
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetToolRouterSessionBySessionIdResponseConfigPreload" /> class.
        /// </summary>
        /// <param name="tools">
        /// Tool slugs preloaded for this session. Appear in `session.tools` and the MCP server tool list, callable directly without going through search. Empty array when no preload was configured.
        /// </param>
...
#endif
        public GetToolRouterSessionBySessionIdResponseConfigPreload(
