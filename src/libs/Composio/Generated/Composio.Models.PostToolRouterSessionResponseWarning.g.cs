...
namespace Composio
{
    ...
    public sealed partial class PostToolRouterSessionResponseWarning
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Composio.JsonConverters.PostToolRouterSessionResponseWarningCodeJsonConverter))]
        public global::Composio.PostToolRouterSessionResponseWarningCode Code { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostToolRouterSessionResponseWarning" /> class.
        /// </summary>
        /// <param name="message">
        /// Human-readable description of the advisory. Suitable for logging or surfacing to end users.<br/>
        /// Example: Session preloads 25 tools; each preloaded tool adds to the agent context window. Consider keeping the list at or under ~20 tools.
...
#endif
        public PostToolRouterSessionResponseWarning(
            string message,
            global::Composio.PostToolRouterSessionResponseWarningCode code)
        {
            this.Code = code;
