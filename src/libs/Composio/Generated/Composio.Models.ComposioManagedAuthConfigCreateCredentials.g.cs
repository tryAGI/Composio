...
namespace Composio
{
    ...
    public sealed partial class ComposioManagedAuthConfigCreateCredentials
    {
        ...
        /// <summary>
        /// OAuth user-token scopes requested for the managed auth config. This is primarily used by Slack OAuth v2.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ComposioManagedAuthConfigCreateCredentials" /> class.
        /// </summary>
        /// <param name="scopes">
        /// OAuth scopes requested for the managed auth config.
        /// </param>
