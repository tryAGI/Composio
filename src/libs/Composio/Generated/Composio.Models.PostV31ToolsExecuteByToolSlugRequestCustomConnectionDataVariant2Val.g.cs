...
namespace Composio
{
    ...
    public sealed partial class PostV31ToolsExecuteByToolSlugRequestCustomConnectionDataVariant2Val
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostV31ToolsExecuteByToolSlugRequestCustomConnectionDataVariant2Val" /> class.
        /// </summary>
        /// <param name="clientId">
        /// Dynamically registered client ID
        /// </param>
...
#endif
        public PostV31ToolsExecuteByToolSlugRequestCustomConnectionDataVariant2Val(
            string clientId,
            string accessToken,
            string? subdomain,
            string? yourDomain,
