...
namespace Composio
{
    ...
    public sealed partial class CustomAuthConfigCreateCredentials
    {
        ...
        /// <summary>
        /// OAuth user-token scopes requested for the custom auth config. This is primarily used by Slack OAuth v2.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomAuthConfigCreateCredentials" /> class.
        /// </summary>
        /// <param name="scopes">
        /// OAuth scopes requested for the custom auth config.
        /// </param>
...
#endif
        public CustomAuthConfigCreateCredentials(
