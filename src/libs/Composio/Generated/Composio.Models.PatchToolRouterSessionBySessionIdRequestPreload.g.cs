...
namespace Composio
{
    ...
    {
        /// <summary>
        /// Composio tool slugs to preload. Each slug must be allowed by the session filters (`toolkits`, `tools`, `tags`) — unknown, blocked, meta, or custom slugs return a 400 at session creation.<br/>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PatchToolRouterSessionBySessionIdRequestPreload" /> class.
        /// </summary>
        /// <param name="tools">
        /// Composio tool slugs to preload. Each slug must be allowed by the session filters (`toolkits`, `tools`, `tags`) — unknown, blocked, meta, or custom slugs return a 400 at session creation.<br/>
        /// Example: [GMAIL_FETCH_EMAILS, SLACK_SEND_MESSAGE]
...
#endif
        public PatchToolRouterSessionBySessionIdRequestPreload(
