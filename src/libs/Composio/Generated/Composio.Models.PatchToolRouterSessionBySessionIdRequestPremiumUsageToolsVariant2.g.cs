...
namespace Composio
{
    ...
    public sealed partial class PatchToolRouterSessionBySessionIdRequestPremiumUsageToolsVariant2
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PatchToolRouterSessionBySessionIdRequestPremiumUsageToolsVariant2" /> class.
        /// </summary>
        /// <param name="disable">
        /// These specific tools will be disabled for this toolkit<br/>
        /// Example: [SLACK_ADD_EMOJI]
...
#endif
        public PatchToolRouterSessionBySessionIdRequestPremiumUsageToolsVariant2(
