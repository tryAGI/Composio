...
namespace Composio
{
    ...
    public sealed partial class PostToolRouterSessionResponseConfigMultiAccount
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostToolRouterSessionResponseConfigMultiAccount" /> class.
        /// </summary>
        /// <param name="enable">
        /// When true, enables multi-account mode for this session. When not set, falls back to org/project-level configuration.
        /// </param>
...
#endif
        public PostToolRouterSessionResponseConfigMultiAccount(
            bool? enable,
