...
namespace Composio
{
    public partial interface IToolRouterClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Composio.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Composio.AutoSDKHttpResponse<global::Composio.ToolRouterToolkitsListResponse>> GetToolRouterSessionBySessionIdToolkitsAsResponseAsync(
            string sessionId,
            int? limit = default,
            string? cursor = default,
            global::System.Collections.Generic.IList<string>? toolkits = default,
