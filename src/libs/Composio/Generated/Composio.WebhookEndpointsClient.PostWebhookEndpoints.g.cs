...
namespace Composio
{
    public partial class WebhookEndpointsClient
    {
        ...
        private static readonly global::Composio.EndPointSecurityRequirement s_PostWebhookEndpointsSecurityRequirement0 =
        ...
        private static readonly global::Composio.EndPointSecurityRequirement[] s_PostWebhookEndpointsSecurityRequirements =
            new global::Composio.EndPointSecurityRequirement[]
            {                s_PostWebhookEndpointsSecurityRequirement0,
            };
        partial void PreparePostWebhookEndpointsArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Composio.PostWebhookEndpointsRequest request);
        partial void PreparePostWebhookEndpointsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Composio.PostWebhookEndpointsRequest request);
        partial void ProcessPostWebhookEndpointsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPostWebhookEndpointsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Composio.PostWebhookEndpointsResponse> PostWebhookEndpointsAsync(

            global::Composio.PostWebhookEndpointsRequest request,
            global::Composio.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await PostWebhookEndpointsAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Composio.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Composio.AutoSDKHttpResponse<global::Composio.PostWebhookEndpointsResponse>> PostWebhookEndpointsAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePostWebhookEndpointsArguments(
            ...
            var __authorizations = global::Composio.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PostWebhookEndpointsSecurityRequirements,
                operationName: "PostWebhookEndpointsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PreparePostWebhookEndpointsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Composio.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Composio.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "PostWebhookEndpointsAsync",
                                pathTemplate: "\"/api/v3/webhook_endpoints\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPostWebhookEndpointsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Composio.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPostWebhookEndpointsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Composio.PostWebhookEndpointsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Composio.AutoSDKHttpResponse<global::Composio.PostWebhookEndpointsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Composio.PostWebhookEndpointsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Composio.PostWebhookEndpointsResponse> PostWebhookEndpointsAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Composio.PostWebhookEndpointsRequest
            {
                ToolkitSlug = toolkitSlug,
                ClientId = clientId,
            };

            return await PostWebhookEndpointsAsync(
                request: __request,
                requestOptions: requestOptions,
