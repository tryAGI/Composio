...
namespace Composio
{
    public partial class ToolsClient
    {
        ...
        private static readonly global::Composio.EndPointSecurityRequirement s_PostToolsExecuteProxySecurityRequirement0 =
        ...
        private static readonly global::Composio.EndPointSecurityRequirement[] s_PostToolsExecuteProxySecurityRequirements =
            new global::Composio.EndPointSecurityRequirement[]
        ...
        public async global::System.Threading.Tasks.Task<global::Composio.PostToolsExecuteProxyResponse> PostToolsExecuteProxyAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Composio.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Composio.AutoSDKHttpResponse<global::Composio.PostToolsExecuteProxyResponse>> PostToolsExecuteProxyAsResponseAsync(
                ...
                else
                {
                    await global::Composio.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 504)
                            {
                                ...
                                global::Composio.Error? __value_504 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_504 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_504 = global::Composio.Error.FromJson(__content_504, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_504 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Composio.PostToolsExecuteProxyResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Composio.AutoSDKHttpResponse<global::Composio.PostToolsExecuteProxyResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Composio.PostToolsExecuteProxyResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
