...
namespace Composio
{
    ...
    public sealed partial class PatchToolRouterSessionBySessionIdResponseConfigWorkbench
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Composio.JsonConverters.PatchToolRouterSessionBySessionIdResponseConfigWorkbenchSandboxSizeJsonConverter))]
        public global::Composio.PatchToolRouterSessionBySessionIdResponseConfigWorkbenchSandboxSize? SandboxSize { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PatchToolRouterSessionBySessionIdResponseConfigWorkbench" /> class.
        /// </summary>
        /// <param name="enable">
        /// Whether the workbench (code execution sandbox) is enabled. When false, COMPOSIO_REMOTE_WORKBENCH and COMPOSIO_REMOTE_BASH_TOOL are not exposed.
        /// </param>
...
#endif
        public PatchToolRouterSessionBySessionIdResponseConfigWorkbench(
            bool? enable,
            bool? proxyExecutionEnabled,
            double? autoOffloadThreshold,
            global::Composio.PatchToolRouterSessionBySessionIdResponseConfigWorkbenchSandboxSize? sandboxSize)
        {
            this.Enable = enable;
