...
namespace Composio
{
    ...
    public sealed partial class PostToolRouterSessionRequestPremiumUsageToolsVariant1
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostToolRouterSessionRequestPremiumUsageToolsVariant1" /> class.
        /// </summary>
        /// <param name="enable">
        /// Only these specific tools will be available for this toolkit<br/>
        /// Example: [GMAIL_SEND_EMAIL, GMAIL_FETCH_EMAILS]
...
#endif
        public PostToolRouterSessionRequestPremiumUsageToolsVariant1(
