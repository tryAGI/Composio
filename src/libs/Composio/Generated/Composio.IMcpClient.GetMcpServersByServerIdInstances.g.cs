...
namespace Composio
{
    public partial interface IMcpClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Composio.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Composio.AutoSDKHttpResponse<global::Composio.GetMcpServersByServerIdInstancesResponse>> GetMcpServersByServerIdInstancesAsResponseAsync(
            string serverId,
            double? pageNo = default,
            double? limit = default,
            string? search = default,
