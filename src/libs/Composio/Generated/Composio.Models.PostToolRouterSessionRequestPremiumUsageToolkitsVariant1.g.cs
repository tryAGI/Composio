...
namespace Composio
{
    ...
    public sealed partial class PostToolRouterSessionRequestPremiumUsageToolkitsVariant1
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostToolRouterSessionRequestPremiumUsageToolkitsVariant1" /> class.
        /// </summary>
        /// <param name="enable">
        /// Only these specific toolkits will be enabled<br/>
        /// Example: [gmail, slack, github]
...
#endif
        public PostToolRouterSessionRequestPremiumUsageToolkitsVariant1(
