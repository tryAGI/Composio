...
{
    private const string UserSecretsId = "Composio.CLI";
    private const string UserSecretApiKeyName = "COMPOSIO_API_KEY";
    private static readonly string[] ApiKeyEnvironmentVariables = [@"COMPOSIO_API_KEY"];
    private const string CredentialFileDirectoryName = ".composio";

    public static async global::System.Threading.Tasks.Task<global::Composio.ComposioClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
        ...
        var authorizations = string.IsNullOrWhiteSpace(apiKey)
            ? new global::System.Collections.Generic.List<global::Composio.EndPointAuthorization>()
            : new global::System.Collections.Generic.List<global::Composio.EndPointAuthorization>
            {
        CreateAuthorization(
            type: "Http",
        ...
        return new global::Composio.ComposioClient(
            httpClient: null,
            baseUri: baseUri,
    ...
    private static global::Composio.EndPointAuthorization CreateAuthorization(
        string type,
        string schemeId,
        string location,
        string name,
        string value)
    {
        var authorization = new global::Composio.EndPointAuthorization
        {
            Type = type,
            Location = location,
            Name = name,
        ...
        var schemeIdProperty = typeof(global::Composio.EndPointAuthorization).GetProperty("SchemeId");
    ...
    public static async global::System.Threading.Tasks.Task<int> RunAsync(Func<global::System.Threading.Tasks.Task> action, CancellationToken cancellationToken = default)
    {
        ...
        catch (global::Composio.ApiException exception)
        {
    ...
    private static Uri? ResolveBaseUri(ParseResult parseResult)
    {
        ...
        {
            baseUrl = Environment.GetEnvironmentVariable("COMPOSIO_BASE_URL");
        }
    ...
    private static async global::System.Threading.Tasks.Task WriteApiExceptionAsync(global::Composio.ApiException exception)
    {
        var builder = new StringBuilder();
