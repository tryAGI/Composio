...
internal static partial class ToolRouterPostToolRouterSessionBySessionIdMountsByMountIdDownloadUrlCommandApiCommand
{
        ...
        name: @"--mount-relative-path")
    {
        ...
        Required = true,
                    ...
                    private static string FormatResponse(ParseResult parseResult, global::Composio.PostToolRouterSessionBySessionIdMountsByMountIdDownloadUrlResponse value, global::System.Text.Json.Serialization.JsonSerializerContext context, bool truncateLongStrings)
                    {
                        string? text = null;
                    ...
                    static partial void CustomizeResponseText(ParseResult parseResult, global::Composio.PostToolRouterSessionBySessionIdMountsByMountIdDownloadUrlResponse value, ref string? text);
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.ToolRouter.PostToolRouterSessionBySessionIdMountsByMountIdDownloadUrlAsync(
                                    sessionId: sessionId,
                                    mountId: mountId,
